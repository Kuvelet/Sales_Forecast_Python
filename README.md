...
### Project Structure
 ...
 forecasting-project/
├── data/
│   ├── all_sku_monthly.csv                  # Raw monthly sales data
│   ├── all_sku_monthly_w0.csv               # Cleaned dataset with zero-sales months filled
│   ├── prophet_full_forecast.csv            # Forecasted values generated by Prophet
│   ├── arima_full_forecast.csv              # Forecasted values generated by ARIMA
│   ├── actual_vs_prophet_forecasts.csv      # Comparison of Prophet forecasts with actuals
│   ├── actual_vs_arima_forecasts.csv        # Comparison of ARIMA forecasts with actuals
│
├── notebooks/
│   ├── 1_prophet_forecasting.ipynb          # End-to-end Prophet forecasting workflow
│   ├── 2_arima_forecasting.ipynb            # End-to-end ARIMA forecasting workflow
│   ├── 3_model_evaluation.ipynb             # Evaluation and comparison of model performance
│
